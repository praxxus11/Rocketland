...
class Manager {
    public:
...
#endif        
        {
            ...
            ai_manager.init_from_file(rockets, "C:\\Users\\Eric\\ProgrammingProjectsCpp\\RocketSaves\\V2Run1\\iteration2850.txt");
#elif defined(GPU)
            ai_manager.init_random(rockets);
            // ai_manager.init_from_file(rockets, "../saves/pres1/iteration9300.txt");
#endif
        }
        ~Manager() 
        {
